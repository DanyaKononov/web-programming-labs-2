...
def list():
    if 'login' in session:
        ...
        db_close(conn, cur)
        return render_template('lab5/articles.html', articles=articles, login=login, articles2 = articles2)
    ...
    articles2 = cur.fetchall()
    db_close(conn, cur)
    return render_template('lab5/articles.html', articles2=articles2)
